        ...
        stage('clone'){
		    steps {
			 script {
			   ...
			   checkout scm: [$class: 'GitSCM', userRemoteConfigs: [[url: 'https://github.com/sampledevops478/cloudfreak.git', credentialsId: '976c8a11-ab25-4ef8-9344-39d3de2f67db' ]], branches: [[name: '+refs/heads/*:refs/remotes/${params.BRANCH} +refs/tags/*:refs/tags/v${GIT_TAG}']]], poll: false
			 }
			}
        }
        stage('Build maven ') {
